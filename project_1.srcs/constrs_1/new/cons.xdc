...
set_property -dict { PACKAGE_PIN U29   IOSTANDARD LVCMOS33 } [get_ports { rdv }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=led[3]
...
## Switches
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS12 } [get_ports { rst1 }]; #IO_0_17 Sch=sw[0]
...
# UART
set_property -dict { PACKAGE_PIN Y23   IOSTANDARD LVCMOS33 } [get_ports { rx }]; #IO_L1P_T0_12 Sch=uart_rx_out
set_property -dict { PACKAGE_PIN Y20   IOSTANDARD LVCMOS33 } [get_ports { tx }]; #IO_0_12 Sch=uart_tx_in
